...
- (void)setup {
	...
	explosionCell.alphaRange = 50;
	explosionCell.alphaSpeed = 0;
...
- (void)animate {
    ...
    [self performSelector:@selector(explode) withObject:nil afterDelay:0.8];
}
// 爆炸
- (void)explode {
    ...
    // 爆炸范围
	[self.explosionLayer setValue:@400 forKeyPath:@"emitterCells.explosion.birthRate"];
